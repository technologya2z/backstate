...
import vn.com.pvcombank.domain.User;
import vn.com.pvcombank.repository.AuthorityRepository;
import vn.com.pvcombank.repository.UserRepository;
import vn.com.pvcombank.security.SecurityUtils;
import vn.com.pvcombank.service.dto.AdminUserDTO;
...
public class UserService {
    ...
    public AdminUserDTO getUserFromAuthentication(AbstractAuthenticationToken authToken) {
        ...
        Optional<User> userbyLogin = userRepository.findOneByLogin(user.getLogin());
        if (userbyLogin.isEmpty()) {
            ...
            user.setAuthorities(userbyLogin.get().getAuthorities());
        }
