...
public class ApiInfoResource {
    ...
    public ResponseEntity<ApiInfo> getApiInfo(@PathVariable Long id) {
        log.debug("REST request to get ApiInfo : {}", id);
        Optional<ApiInfo> apiInfoDTO = apiInfoService.findOne(id);
        return ResponseEntity.ok().body(apiInfoDTO.get());
    }
