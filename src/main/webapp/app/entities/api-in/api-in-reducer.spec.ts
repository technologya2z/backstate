...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './api-in.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_APIIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APIIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APIIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APIIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APIIN actions', async () => {
      const expectedActions = [
        {
