...
import { getEntities } from './api-in.reducer';

export const ApiIn = (props: RouteComponentProps<{ url: string }>) => {
      ...
      <h2 id="api-in-heading" data-cy="ApiInHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="cmspApp.apiIn.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/api-in/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="cmspApp.apiIn.home.createLabel">Create new Api In</Translate>
          </Link>
        </div>
      </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="cmspApp.apiIn.application">Application</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="cmspApp.apiIn.apiInfo">Api Info</Translate> <FontAwesomeIcon icon="sort" />
                </th>
