...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './api-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APIINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APIINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APIINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APIINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APIINFO actions', async () => {
      const expectedActions = [
        {
