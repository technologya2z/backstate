...
import { getEntities, searchEntities } from './api-info.reducer';
        ...
        <div className="d-flex justify-content-end">
          <ValidatedForm defaultValues={{}} onSubmit={handleFilter}>
            ...
            <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
              ...
              <Translate contentKey="cmspApp.apiInfo.home.refreshListLabel">Refresh List</Translate>
            </Button>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('requestExample')}>
                  <Translate contentKey="cmspApp.apiInfo.requestExample">Request Example</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('responseExample')}>
                  <Translate contentKey="cmspApp.apiInfo.responseExample">Response Example</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('dateCreate')}>
                  <Translate contentKey="cmspApp.apiInfo.dateCreate">Date Create</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {apiInfoList.map((apiInfo, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{apiInfo.path}</td>
                  <td>{apiInfo.requestExample}</td>
                  <td>{apiInfo.responseExample}</td>
                  <td>
