    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="description">
              <Translate contentKey="cmspApp.apiOut.description">Description</Translate>
            </span>
          </dt>
          <dd>{apiOutEntity.description}</dd>
          <dt>
            <span id="dateConnect">
              <Translate contentKey="cmspApp.apiOut.dateConnect">Date Connect</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="cmspApp.apiOut.application">Application</Translate>
          </dt>
