...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './api-out.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_APIOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APIOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APIOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APIOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APIOUT actions', async () => {
      const expectedActions = [
        {
