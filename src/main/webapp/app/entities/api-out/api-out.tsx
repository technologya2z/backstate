...
import { getEntities } from './api-out.reducer';

export const ApiOut = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="api-out-heading" data-cy="ApiOutHeading">
        <Translate contentKey="cmspApp.apiOut.home.title">Api Outs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="cmspApp.apiOut.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/api-out/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="cmspApp.apiOut.home.createLabel">Create new Api Out</Translate>
          </Link>
        </div>
      </h2>
