...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICATION actions', async () => {
      const expectedActions = [
        {
