...
export const searchEntitiesApplication = createAsyncThunk(
  'apiIn/fetch_entity_list_application',
...
export const ApplicationSlice = createEntitySlice({
  ...
  extraReducers(builder) {
    builder
      ...
      .addMatcher(isFulfilled(getEntities, searchEntitiesApplication), (state, action) => {
      ...
      .addMatcher(isPending(getEntities, getEntity, searchEntitiesApplication), state => {
