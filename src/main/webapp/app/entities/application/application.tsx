        ...
        <div className="d-flex justify-content-end">
          <ValidatedForm defaultValues={{}} onSubmit={handleFilter}>
            ...
            <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
              ...
              <Translate contentKey="cmspApp.application.home.refreshListLabel">Refresh List</Translate>
            </Button>
            <Link to="/application/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
              <FontAwesomeIcon icon="plus" />
              &nbsp;
              <Translate contentKey="cmspApp.application.home.createLabel">Create new Application</Translate>
            </Link>
          </ValidatedForm>
        </div>
      </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('dateGolive')}>
            ...
            <tbody>
              {applicationList.map((application, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {application.dateStart ? <TextFormat type="date" value={application.dateStart} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    <label>{application.appType === ApplicationType ? 'Nội bộ' : 'Đối tác'}</label>
                  </td>
                  <td>
