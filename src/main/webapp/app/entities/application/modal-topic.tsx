...
import { searchEntities } from 'app/entities/topic-in/topic-in.reducer';
import { searchEntities as getEntitiesTopicOutId } from 'app/entities/topic-out/topic-out.reducer';
