...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './area.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AREA_LIST actions', async () => {
    ...
    it('dispatches FETCH_AREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AREA actions', async () => {
      const expectedActions = [
        {
