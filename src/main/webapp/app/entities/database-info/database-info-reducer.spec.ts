...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './database-info.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IDatabaseInfo, defaultValue } from 'app/shared/model/database-info.model';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IDatabaseInfo> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATABASEINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DATABASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DATABASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DATABASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DATABASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DATABASEINFO actions', async () => {
      const expectedActions = [
        {
