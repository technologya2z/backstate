  ...
  return (
    <div>
      <h2 id="database-info-heading" data-cy="DatabaseInfoHeading">
        <Translate contentKey="cmspApp.databaseInfo.home.title">Database Infos</Translate>
        <div className="d-flex justify-content-end">
          <ValidatedForm defaultValues={{}} onSubmit={handleFilter}>
            ...
            <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
              ...
              <Translate contentKey="cmspApp.databaseInfo.home.refreshListLabel">Refresh List</Translate>
            </Button>
            <Link to="/database-info/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
              <FontAwesomeIcon icon="plus" />
              &nbsp;
              <Translate contentKey="cmspApp.databaseInfo.home.createLabel">Create new Database Info</Translate>
            </Link>
          </ValidatedForm>
        </div>
      </h2>
