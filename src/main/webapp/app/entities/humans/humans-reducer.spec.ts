...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './humans.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUMANS_LIST actions', async () => {
    ...
    it('dispatches FETCH_HUMANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HUMANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HUMANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HUMANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HUMANS actions', async () => {
      const expectedActions = [
        {
