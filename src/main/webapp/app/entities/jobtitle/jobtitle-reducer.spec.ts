...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './jobtitle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBTITLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBTITLE actions', async () => {
      const expectedActions = [
        {
