...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPERAUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPERAUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPERAUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPERAUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPERAUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPERAUNIT actions', async () => {
      const expectedActions = [
        {
