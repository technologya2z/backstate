        ...
        <div className="d-flex justify-content-end">
          <ValidatedForm defaultValues={{}} onSubmit={handleFilter}>
            ...
            <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
              ...
              <Translate contentKey="cmspApp.operaUnit.home.refreshListLabel">Refresh List</Translate>
            </Button>
            <Link to="/opera-unit/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
              <FontAwesomeIcon icon="plus" />
              &nbsp;
              <Translate contentKey="cmspApp.operaUnit.home.createLabel">Create new Opera Unit</Translate>
            </Link>
          </ValidatedForm>
        </div>
      </h2>
