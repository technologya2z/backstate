...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORGANIZATION actions', async () => {
      const expectedActions = [
        {
