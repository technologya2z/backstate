    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="dateConnect">
              <Translate contentKey="cmspApp.topicIn.dateConnect">Date Connect</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="description">
              <Translate contentKey="cmspApp.topicIn.description">Description</Translate>
            </span>
          </dt>
          <dd>{topicInEntity.description}</dd>
          <dt>
            <Translate contentKey="cmspApp.topicIn.topic">Topic</Translate>
          </dt>
