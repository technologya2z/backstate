...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './topic-in.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICIN actions', async () => {
      const expectedActions = [
        {
