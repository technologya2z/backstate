...
import { getEntity, updateEntity, createEntity, reset } from './topic-in.reducer';
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <div style={{ width: '100%' }}>
                <label>{translate('cmspApp.topicIn.application')}</label>
                <br />
                <MultiSelect
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/topic-in" replace color="info">
