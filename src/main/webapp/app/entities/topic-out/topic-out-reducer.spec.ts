...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './topic-out.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICOUT actions', async () => {
      const expectedActions = [
        {
