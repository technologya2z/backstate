...
import { searchEntities as searchTopicIn } from 'app/entities/topic-in/topic-in.reducer';
import { searchEntities as searchTopicOut } from 'app/entities/topic-out/topic-out.reducer';
