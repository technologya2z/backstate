...
import { getEntities, searchEntities } from './topic.reducer';
        ...
        <div className="d-flex justify-content-end">
          <ValidatedForm defaultValues={{}} onSubmit={handleFilter}>
            ...
            <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
              ...
              <Translate contentKey="cmspApp.topic.home.refreshListLabel">Refresh List</Translate>
            </Button>
            <Link to="/topic/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
              <FontAwesomeIcon icon="plus" />
              &nbsp;
              <Translate contentKey="cmspApp.topic.home.createLabel">Create new Topic</Translate>
            </Link>
          </ValidatedForm>
        </div>
      </h2>
